...
input_dir = "/g/g91/gysbers1/Code/Chloe_data"

# full path to ncsd output for target nucleus (so we can get Rp, Rn, Rm):
ncsd_file_target = f"{input_dir}/4He_1pos_N3LO_SRG1.5_6_out.txt"
ncsd_file_resultant = f"{input_dir}/6Li_5pos_N3LO_SRG1.5_8_out.txt"
nmax = 6

# path to executable file
exe_path = "/g/g91/gysbers1/Code/transitions_NCSMC/transitions_NCSMC.exe"

# where are your ncsmc output files stored?
ncsmc_out_dir = f"{input_dir}"
